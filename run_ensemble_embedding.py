...
if __name__ == "__main__":
    ...
    for subgraph_size_range in subgraph_size_range_list:
        ...
        dataset_out_dir = f"KGEmb\\data\\{dataset_out}"
        ...
        logging.basicConfig(
            ...
            level=logging.INFO,
            datefmt="%Y-%m-%d %H:%M:%S",
            filename=os.path.join(info_directory, "Ensemble_Embedding.log"),
            filemode="w"
        )
        ...
        #     "D:\\OneDrive - bwedu\\MASTER\\Masterarbeit\\Software\\Ensemble_Embedding\\Random_Triples.csv",
        #     f"D:\\OneDrive - bwedu\\MASTER\\Masterarbeit\\Software\\Ensemble_Embedding\\KGEmb\\data\\"
        #     f"Debug\\train")
        ...
        # for dataset in os.scandir("KGEmb\\data"):
        #     print(dataset.name)
