...
from ensemble import Attention_mechanism, Constants, util_files, util
...
def own_train(info_directory, dataset="WN18RR", dataset_directory="data\\WN18RR", kge_models=None,
