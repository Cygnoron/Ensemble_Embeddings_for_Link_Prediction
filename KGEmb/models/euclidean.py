...
from KGEmb.utils.euclidean import euc_sqdistance, givens_rotations, givens_reflection

EUC_MODELS = ["TransE", "DistMult", "CP", "MurE", "RotE", "RefE", "AttE"]
...
class TransE(BaseE):
    ...
    def get_queries(self, queries):
        ...
        self.theta_entity(queries[:, 0]).view((-1, 1, self.rank))
        self.context_vec(queries[:, 1]).view((-1, 1, self.rank))
