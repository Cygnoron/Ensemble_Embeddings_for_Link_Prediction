...
def process_specific_dataset(dataset, directory):
    """
    The process_specific_dataset function takes in a dataset name and processes the data for that specific dataset.

    :param dataset: The dataset, that is to be processed
    :param directory: The directory, where the dataset is located
    :return: A dictionary with the train, valid and test sets
    """
    data_path = directory
    dataset_name = data_path + "\\" + dataset
...
def process_dataset_main(data_dir):
    """
    The process_dataset_main function takes in a dataset directory and processes all the datasets in this directory.

    :param data_dir: The directory, were all datasets to be processed are located
    :return: A dictionary with the train, valid and test sets
    """
